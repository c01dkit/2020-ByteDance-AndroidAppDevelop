...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator objectAnimator2 = ObjectAnimator.ofFloat(target,
                "alpha",1f,0.5f);
        objectAnimator2.setRepeatCount(ValueAnimator.INFINITE);
        objectAnimator2.setInterpolator(new LinearInterpolator());
        objectAnimator2.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        objectAnimator2.setRepeatMode(ValueAnimator.REVERSE);

        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,scaleXAnimator,scaleYAnimator,objectAnimator2);
        animatorSet.start();
    }
}
